...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, OrderDO> implements OrderService {
    ...
    public void successOrderAndUser(UserDO userDO, OrderDO orderDO) {
//        log.info("订单：{}", orderDO);
...
//                userDO.getVipStartTime() + "#" + userDO.getVipEndTime(), RedisConstant.USER_VIP_INFO_VALID_TIME, TimeUnit.SECONDS);
        // 更新用户VIP时间
