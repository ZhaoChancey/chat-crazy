...
//    private String parentMessageId;
    ...
    public static ChatReplyMessageVO onEmitterChainException(ChatProcessRequest request) {
        ...
        chatReplyMessageVO.setId(Optional.ofNullable(options).orElse(new ChatProcessRequest.Options()).getParentMessageId());
        chatReplyMessageVO.setConversationId(Optional.ofNullable(options).orElse(new ChatProcessRequest.Options()).getConversationId());
